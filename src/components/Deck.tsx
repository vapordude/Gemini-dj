          ...
          <div className="flex gap-2 h-1/2">
            <div className="flex-1 bg-zinc-900/50 rounded-lg border border-white/5 flex flex-col items-center justify-center p-1">
              ...
              <input
                ...
                aria-label={`Filter Frequency Deck ${id}`}
                title="Filter Frequency"
                className="w-full h-1 bg-zinc-700 rounded-full appearance-none accent-yellow-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
            ...
            <div className="flex-1 bg-zinc-900/50 rounded-lg border border-white/5 flex flex-col items-center justify-center p-1">
              ...
              <input
                ...
                aria-label={`Echo Amount Deck ${id}`}
                title="Echo Amount"
                className="w-full h-1 bg-zinc-700 rounded-full appearance-none accent-cyan-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
              ...
              <div key={band} className="h-full flex flex-col items-center justify-center w-8 group/eq">
                <div className="h-8 w-1 bg-zinc-800 rounded-full relative">
                  <input
                    ...
                    aria-label={`EQ ${band.toUpperCase()} Deck ${id}`}
                    title={`EQ ${band.toUpperCase()}`}
                    className="absolute inset-0 opacity-0 cursor-pointer z-10 peer focus-visible:outline-none"
