              ...
              <div key={band} className="h-full flex flex-col items-center justify-center w-8 group/eq">
                <div className="h-8 w-1 bg-zinc-800 rounded-full relative">
                  ...
                  <input
                    ...
                    aria-label={`${band.toUpperCase()} EQ Deck ${id}`}
                    title={`${band.toUpperCase()} EQ Deck ${id}`}
                  ...
                  />
                  <div className="absolute inset-0 pointer-events-none rounded-sm peer-focus-visible:ring-2 peer-focus-visible:ring-offset-1 peer-focus-visible:ring-offset-zinc-800 peer-focus-visible:ring-indigo-400" />
                </div>
