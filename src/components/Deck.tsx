      ...
      <div className="grid grid-cols-4 gap-3 relative z-10 h-32">
        ...
        <div className="col-span-1 flex items-center justify-center">
          <button
            ...
            className={`w-full h-full rounded-xl flex items-center justify-center transition-all shadow-xl border focus-visible:ring-2 focus-visible:outline-none ${isDeckA ? 'focus-visible:ring-indigo-400' : 'focus-visible:ring-purple-400'} ${
              isPlaying
