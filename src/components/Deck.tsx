      ...
      <div className="grid grid-cols-4 gap-3 relative z-10 h-32">
        ...
        <div className="col-span-1 flex items-center justify-center">
          <button
            ...
            className={`w-full h-full rounded-xl flex items-center justify-center transition-all shadow-xl border focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50 ${
              isPlaying
