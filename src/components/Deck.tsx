          ...
          <div className="flex gap-2 h-1/2">
            <div className="flex-1 bg-zinc-900/50 rounded-lg border border-white/5 flex flex-col items-center justify-center p-1">
              ...
              <input
                ...
                className="w-full h-1 bg-zinc-700 rounded-full appearance-none accent-yellow-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
            ...
            <div className="flex-1 bg-zinc-900/50 rounded-lg border border-white/5 flex flex-col items-center justify-center p-1">
              ...
              <input
                ...
                title={`Deck ${id} Echo`}
                className="w-full h-1 bg-zinc-700 rounded-full appearance-none accent-cyan-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
              ...
              <div key={band} className="h-full flex flex-col items-center justify-center w-8 group/eq">
                <div className="h-8 w-1 bg-zinc-800 rounded-full relative">
                  <input
                    ...
                    aria-label={`Deck ${id} EQ ${band.charAt(0).toUpperCase() + band.slice(1)}`}
                    title={`Deck ${id} EQ ${band.charAt(0).toUpperCase() + band.slice(1)}`}
