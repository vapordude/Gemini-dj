      ...
      <div className="grid grid-cols-4 gap-3 relative z-10 h-32">
        ...
        <div className="col-span-1 flex items-center justify-center">
          <button
            ...
            className={`w-full h-full rounded-xl flex items-center justify-center transition-all shadow-xl border focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:outline-none ${
              isPlaying
          ...
          <div className="flex gap-2 h-1/2">
            <div className="flex-1 bg-zinc-900/50 rounded-lg border border-white/5 flex flex-col items-center justify-center p-1">
              ...
              <input
                ...
                className="w-full h-1 bg-zinc-700 rounded-full appearance-none accent-yellow-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400"
            ...
            <div className="flex-1 bg-zinc-900/50 rounded-lg border border-white/5 flex flex-col items-center justify-center p-1">
              ...
              <input
                ...
                aria-label="Echo" title="Echo"
                className="w-full h-1 bg-zinc-700 rounded-full appearance-none accent-cyan-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400"
              ...
              <div key={band} className="h-full flex flex-col items-center justify-center w-8 group/eq">
                <div className="h-8 w-1 bg-zinc-800 rounded-full relative">
                  <input
                    ...
                    aria-label={`${band} EQ`} title={`${band} EQ`}
