          ...
          <div className="w-full max-w-[120px] relative h-64 flex items-center justify-center">
            ...
            */}
            ...
            <div className="relative w-full h-12 flex items-center">
                ...
                {/* Physical Fader Cap */}
                <div 
                className="absolute h-10 w-6 bg-gradient-to-b from-zinc-200 to-zinc-400 rounded-sm shadow-[0_4px_10px_rgba(0,0,0,0.5)] border-t border-white/50 z-20 pointer-events-none flex items-center justify-center peer-focus-visible:ring-2 peer-focus-visible:ring-emerald-400 peer-focus-visible:outline-none"
                style={{ 
                    left: `${crossfader * 100}%`,
