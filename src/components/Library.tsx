...
export function Library({ onLoadTrack, onQueueTracks }: LibraryProps) {
  ...
  return (
    <div className="h-full flex flex-col relative">
      {/* Tabs */}
      <div className="flex border-b border-white/5 bg-zinc-900/30" role="tablist" aria-label="Library views">
...
function TabButton({ active, onClick, icon: Icon, label }: { active: boolean; onClick: () => void; icon: any; label: string }) {
  return (
    <button
      ...
      title={label}
      onClick={onClick}
      className={`flex-1 py-3 flex justify-center items-center transition-all border-b-2 relative overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 -outline-offset-2 z-10 ${
