...
function TabButton({ active, onClick, icon: Icon, label }: { active: boolean; onClick: () => void; icon: any; label: string }) {
  return (
    <button
      ...
      aria-label={label}
      title={label}
      className={`flex-1 py-3 flex justify-center items-center transition-all border-b-2 relative overflow-hidden focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:outline-none focus-visible:z-10 ${
