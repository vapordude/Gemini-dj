...
import { Send, Music, Sparkles, Youtube, Mic, X, Zap } from 'lucide-react';
    ...
    <>
      ...
      {!isOpen && (
        <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 p-4 bg-indigo-600 rounded-full shadow-2xl text-white border border-indigo-400 group"
        >
          ...
          >
            ...
            <div className="p-4 bg-zinc-900/50 border-t border-white/10">
              ...
              <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-none">
                ...
                >
                  <Zap size={10} className="text-yellow-500" /> STUTTER
                </button>
                <button 
