    ...
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 p-4 bg-indigo-600 rounded-full shadow-2xl text-white border border-indigo-400
          transition-all duration-200 hover:scale-110 active:scale-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400
        ...
        <div className="p-4 bg-zinc-900/50 border-t border-white/10">
          <div className="flex gap-2 mb-3">
            ...
            <button
              ...
              className="p-2.5 bg-indigo-600 rounded-xl text-white hover:bg-indigo-500 transition-all shadow-lg shadow-indigo-500/20 border border-indigo-400/50 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
            >
              <Send size={18} />
            </button>
          </div>
